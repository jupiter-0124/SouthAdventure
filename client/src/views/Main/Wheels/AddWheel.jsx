...
import { addWheelRequest } from '../../../store/actions/wheelActions';
...
class AddWheel extends React.Component {
  state = {
    data: {
      make_id: '',
      model: '',
  ...
  handleSubmit = (e) => {
    ...
    if(!hasError) {
      this.props.addWheelRequest(this.state.data)
      .then(res => {
        if (res.errors) {
          this.setState(prevState => {
            return {
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="info" icon>
              ...
              <h4 className={classes.cardIconTitle}>Add Wheel</h4>
            </CardHeader>
            <CardBody>
...
const mapDispatchToProps = dispatch => {
  return {
      addWheelRequest: (data) => dispatch(addWheelRequest(data))
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(regularFormsStyle)(AddWheel));

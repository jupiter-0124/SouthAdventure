  ...
  render() {
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={this.props.authenticatedUsername}
                secondary={
                  <b
                    className={
                      caret +
            ...
            <Collapse in={this.state.openAvatar} unmountOnExit>
              <List className={classes.list + " " + classes.collapseList}>
                <ListItem className={classes.collapseItem} onClick={this.props.userLogoutRequest}>
                  <NavLink
                    to="#"
                    className={
    ...
    var brand = (
      <div className={logoClasses}>
        <a href="http://54.67.113.64:3000" className={logoMini}>
          <img src={logo} alt="logo" className={classes.img} />
        </a>
        <a href="http://54.67.113.64:3000" className={logoNormal}>
          {logoText}
        </a>
      </div>
    );
